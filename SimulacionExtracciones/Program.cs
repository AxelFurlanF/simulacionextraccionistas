...
namespace SimulacionExtracciones
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (t <= tf)
            {
                simulacion(e, out t, ref tpll, ref ns, out currentTps, ref nt, ref ss, ref sll, ref sta, tps, ito, sto,  rnd);
            }
            while (ns > 0)
            {
                tpll = hv;
        ...
        private static void simulacion(int e, out int t, ref int tpll, ref int ns, out int currentTps, ref int nt, ref int ss, ref int sll, ref int sta, int[] tps, int[] ito, int[] sto, Random rnd)
        {
